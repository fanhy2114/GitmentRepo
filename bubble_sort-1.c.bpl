// generated by SMACK version 1.5.2 for boogie
// via /usr/local/bin/smack bubble_sort-1.c -bpl bubble_sort-1.c.bpl --verifier boogie
...
$bb0:
  ...
  assume true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 96, 1} true;
  $exn := false;
  return;
}
...
procedure {:inline 1} __SMACK_code.ref.ref.ref.ref.ref.ref($p0: ref, p.1: ref, p.2: ref, p.3: ref, p.4: ref, p.5: ref);
procedure {:inline 1} __SMACK_code.ref.ref.ref.ref($p0: ref, p.1: ref, p.2: ref, p.3: ref);
procedure {:inline 1} __SMACK_code.ref.ref.ref($p0: ref, p.1: ref, p.2: ref);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 92));
...
axiom (__SMACK_check_memory_safety == $sub.ref(0, 116));
procedure {:inline 1} __SMACK_check_memory_safety(pointer: ref, size: i64)
{
  var $p0: ref;
$bb0:
  call {:cexpr "pointer"} boogie_si_record_ref(pointer);
  call {:cexpr "size"} boogie_si_record_i64(size);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1016, 19} true;
  $p0 := $i2p.i64.ref(size);
  call {:cexpr "sizeRef"} boogie_si_record_ref($p0);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1017, 3} true;
  assert $slt.ref.bool(pointer, $0.ref) || $Alloc[$base(pointer)] == true;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1018, 3} true;
  assert $slt.ref.bool(pointer, $0.ref) || $sle.ref.bool($base(pointer), pointer);
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1020, 5} true;
  assert $slt.ref.bool(pointer, $0.ref) || $sle.ref.bool($add.ref(pointer, $p0), $add.ref($base(pointer), $Size($base(pointer))));
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1026, 1} true;
  $exn := false;
  return;
}
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 124));
procedure {:inline 1} __SMACK_init_func_memory_model()
{
$bb0:
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1029, 3} true;
  $CurrAddr := $1024.ref;
  assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 1030, 1} true;
  $exn := false;
  return;
}
const bubblesort: ref;
axiom (bubblesort == $sub.ref(0, 132));
procedure {:inline 1} bubblesort(size: i32, item: ref)
{
  var $i0: i32;
  var $i1: i1;
  var $i2: i32;
  ...
  var $i29: i32;
$bb0:
  call {:cexpr "size"} boogie_si_record_i32(size);
  call {:cexpr "item"} boogie_si_record_ref(item);
  call {:cexpr "a"} boogie_si_record_i32(1);
  assume {:sourceloc "bubble_sort-1.c", 16, 6} true;
  $i0 := 1;
  goto $bb1;
$bb1:
  assume {:sourceloc "bubble_sort-1.c", 16, 13} true;
  $i1 := $slt.i32($i0, size);
  assume {:sourceloc "bubble_sort-1.c", 16, 2} true;
  assume {:branchcond $i1} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i1 == 1);
  assume {:sourceloc "bubble_sort-1.c", 18, 11} true;
  $i2 := $sub.i32(size, 1);
  call {:cexpr "b"} boogie_si_record_i32($i2);
  assume {:sourceloc "bubble_sort-1.c", 18, 7} true;
  $i3 := $i2;
  goto $bb4;
$bb3:
  assume !(($i1 == 1));
  assume {:sourceloc "bubble_sort-1.c", 32, 1} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "bubble_sort-1.c", 18, 19} true;
  $i4 := $sge.i32($i3, $i0);
  assume {:sourceloc "bubble_sort-1.c", 18, 3} true;
  assume {:branchcond $i4} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i4 == 1);
  assume {:sourceloc "bubble_sort-1.c", 21, 8} true;
  $i5 := $sub.i32($i3, 1);
  assume {:sourceloc "bubble_sort-1.c", 21, 8} true;
  $i6 := $slt.i32($i5, size);
  assume {:sourceloc "bubble_sort-1.c", 21, 8} true;
...
$bb6:
  assume !(($i4 == 1));
  assume {:sourceloc "bubble_sort-1.c", 16, 23} true;
  $i29 := $add.i32($i0, 1);
...
$bb7:
  assume ($i6 == 1);
  assume {:sourceloc "bubble_sort-1.c", 21, 22} true;
  $i7 := $slt.i32($i3, size);
  assume {:sourceloc "bubble_sort-1.c", 21, 8} true;
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "bubble_sort-1.c", 18, 27} true;
  $i28 := $add.i32($i3, $sub.i32(0, 1));
...
$bb10:
  assume ($i7 == 1);
  assume {:sourceloc "bubble_sort-1.c", 23, 14} true;
  $i8 := $sub.i32($i3, 1);
  assume {:sourceloc "bubble_sort-1.c", 23, 8} true;
  $i9 := $sext.i32.i64($i8);
  assume {:sourceloc "bubble_sort-1.c", 23, 8} true;
  $p10 := $add.ref(item, $mul.ref($i9, 4));
  assume {:sourceloc "bubble_sort-1.c", 23, 8} true;
  $i11 := $load.i32($M.0, $p10);
  assume {:sourceloc "bubble_sort-1.c", 23, 23} true;
  $i12 := $sext.i32.i64($i3);
  assume {:sourceloc "bubble_sort-1.c", 23, 23} true;
  $p13 := $add.ref(item, $mul.ref($i12, 4));
  assume {:sourceloc "bubble_sort-1.c", 23, 23} true;
...
$bb12:
  assume ($i15 == 1);
  assume {:sourceloc "bubble_sort-1.c", 25, 16} true;
  $i16 := $sub.i32($i3, 1);
  assume {:sourceloc "bubble_sort-1.c", 25, 10} true;
  $i17 := $sext.i32.i64($i16);
  assume {:sourceloc "bubble_sort-1.c", 25, 10} true;
  $p18 := $add.ref(item, $mul.ref($i17, 4));
  assume {:sourceloc "bubble_sort-1.c", 25, 10} true;
  $i19 := $load.i32($M.0, $p18);
  call {:cexpr "t"} boogie_si_record_i32($i19);
  assume {:sourceloc "bubble_sort-1.c", 26, 21} true;
  $i20 := $sext.i32.i64($i3);
  assume {:sourceloc "bubble_sort-1.c", 26, 21} true;
  $p21 := $add.ref(item, $mul.ref($i20, 4));
  assume {:sourceloc "bubble_sort-1.c", 26, 21} true;
  $i22 := $load.i32($M.0, $p21);
  assume {:sourceloc "bubble_sort-1.c", 26, 12} true;
  $i23 := $sub.i32($i3, 1);
  assume {:sourceloc "bubble_sort-1.c", 26, 6} true;
  $i24 := $sext.i32.i64($i23);
  assume {:sourceloc "bubble_sort-1.c", 26, 6} true;
  $p25 := $add.ref(item, $mul.ref($i24, 4));
  assume {:sourceloc "bubble_sort-1.c", 26, 6} true;
  $M.0 := $store.i32($M.0, $p25, $i22);
  assume {:sourceloc "bubble_sort-1.c", 27, 6} true;
  $i26 := $sext.i32.i64($i3);
  assume {:sourceloc "bubble_sort-1.c", 27, 6} true;
  $p27 := $add.ref(item, $mul.ref($i26, 4));
  assume {:sourceloc "bubble_sort-1.c", 27, 6} true;
  $M.0 := $store.i32($M.0, $p27, $i19);
  assume {:sourceloc "bubble_sort-1.c", 28, 5} true;
  goto $bb9;
$bb13:
  assume {:sourceloc "bubble_sort-1.c", 23, 8} true;
  assume !(($i15 == 1));
...
const q1: ref;
axiom (q1 == $sub.ref(0, 140));
procedure {:inline 1} q1(argc: i32, argv: ref)
{
  var $i0: i1;
  var $i1: i32;
  var $i2: i64;
...
$bb0:
  ...
  assume {:sourceloc "bubble_sort-1.c", 54, 5} true;
  $i0 := $slt.i32(argc, 2);
  assume {:sourceloc "bubble_sort-1.c", 54, 5} true;
...
$bb1:
  ...
  goto $bb2;
$bb2:
  assume {:sourceloc "bubble_sort-1.c", 85, 1} true;
  $exn := false;
  return;
$bb3:
  assume !(($i0 == 1));
  assume {:sourceloc "bubble_sort-1.c", 57, 10} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "N"} boogie_si_record_i32($i1);
  assume {:sourceloc "bubble_sort-1.c", 58, 2} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "bubble_sort-1.c", 58, 2} true;
  ...
  assume {:sourceloc "bubble_sort-1.c", 72, 8} true;
  $i5 := 0;
  goto $bb4;
$bb4:
  assume {:sourceloc "bubble_sort-1.c", 72, 13} true;
  $i6 := $slt.i32($i5, $i1);
  assume {:sourceloc "bubble_sort-1.c", 72, 4} true;
  assume {:branchcond $i6} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i6 == 1);
  assume {:sourceloc "bubble_sort-1.c", 72, 25} true;
  $i7 := $sext.i32.i64($i5);
  assume {:sourceloc "bubble_sort-1.c", 72, 25} true;
  $p8 := $add.ref($p4, $mul.ref($i7, 4));
  assume {:sourceloc "bubble_sort-1.c", 72, 25} true;
  $M.0 := $store.i32($M.0, $p8, $i5);
  assume {:sourceloc "bubble_sort-1.c", 72, 20} true;
  $i9 := $add.i32($i5, 1);
...
$bb6:
  assume !(($i6 == 1));
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "bubble_sort-1.c", 74, 10} true;
  $i10 := 0;
  goto $bb7;
$bb7:
  assume {:sourceloc "bubble_sort-1.c", 74, 15} true;
  $i11 := $slt.i32($i10, $i1);
  assume {:sourceloc "bubble_sort-1.c", 74, 5} true;
  assume {:branchcond $i11} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i11 == 1);
  assume {:sourceloc "bubble_sort-1.c", 75, 22} true;
  call $i12 := __VERIFIER_nondet_int();
  assume {:sourceloc "bubble_sort-1.c", 75, 49} true;
  $i13 := $sub.i32($i1, $i10);
  assume {:sourceloc "bubble_sort-1.c", 75, 22} true;
  $i14 := $srem.i32($i12, $i13);
  assume {:sourceloc "bubble_sort-1.c", 75, 17} true;
  $i15 := $add.i32($i10, $i14);
  call {:cexpr "r"} boogie_si_record_i32($i15);
  assume {:sourceloc "bubble_sort-1.c", 76, 20} true;
  $i16 := $sext.i32.i64($i10);
  assume {:sourceloc "bubble_sort-1.c", 76, 20} true;
  $p17 := $add.ref($p4, $mul.ref($i16, 4));
  assume {:sourceloc "bubble_sort-1.c", 76, 20} true;
  $i18 := $load.i32($M.0, $p17);
  call {:cexpr "temp"} boogie_si_record_i32($i18);
  assume {:sourceloc "bubble_sort-1.c", 77, 16} true;
  $i19 := $sext.i32.i64($i15);
  assume {:sourceloc "bubble_sort-1.c", 77, 16} true;
  $p20 := $add.ref($p4, $mul.ref($i19, 4));
  assume {:sourceloc "bubble_sort-1.c", 77, 16} true;
  $i21 := $load.i32($M.0, $p20);
  assume {:sourceloc "bubble_sort-1.c", 77, 9} true;
  $i22 := $sext.i32.i64($i10);
  assume {:sourceloc "bubble_sort-1.c", 77, 9} true;
  $p23 := $add.ref($p4, $mul.ref($i22, 4));
  assume {:sourceloc "bubble_sort-1.c", 77, 9} true;
  $M.0 := $store.i32($M.0, $p23, $i21);
  assume {:sourceloc "bubble_sort-1.c", 78, 9} true;
  $i24 := $sext.i32.i64($i15);
  assume {:sourceloc "bubble_sort-1.c", 78, 9} true;
  $p25 := $add.ref($p4, $mul.ref($i24, 4));
  assume {:sourceloc "bubble_sort-1.c", 78, 9} true;
  $M.0 := $store.i32($M.0, $p25, $i18);
  assume {:sourceloc "bubble_sort-1.c", 74, 20} true;
  $i26 := $add.i32($i10, 1);
...
$bb9:
  assume !(($i11 == 1));
  assume {:sourceloc "bubble_sort-1.c", 83, 3} true;
  call bubblesort($i1, $p4);
  assume {:sourceloc "bubble_sort-1.c", 85, 1} true;
...
axiom (llvm.stacksave == $sub.ref(0, 148));
procedure {:inline 1} llvm.stacksave()
  returns ($r: ref);
const llvm.stackrestore: ref;
axiom (llvm.stackrestore == $sub.ref(0, 156));
procedure {:inline 1} llvm.stackrestore($p0: ref);
const main: ref;
axiom (main == $sub.ref(0, 164));
...
$bb0:
  ...
  call {:cexpr "argc"} boogie_si_record_i32(argc);
  call {:cexpr "argv"} boogie_si_record_ref(argv);
  assume {:sourceloc "bubble_sort-1.c", 89, 2} true;
  call q1(argc, argv);
  assume {:sourceloc "bubble_sort-1.c", 92, 2} true;
  $r := 0;
  $exn := false;
  return;
}
