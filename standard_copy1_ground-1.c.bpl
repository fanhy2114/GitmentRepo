...
// via /usr/local/bin/smack standard_copy1_ground-1.c -bpl standard_copy1_ground-1.c.bpl --verifier boogie
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 150));
...
const .str3: ref;
axiom (.str3 == $sub.ref(0, 46));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 54));
procedure {:inline 1} llvm.dbg.declare($p0: ref, $p1: ref, $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 62));
...
axiom (__SMACK_code == $sub.ref(0, 70));
...
axiom (__VERIFIER_error == $sub.ref(0, 78));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 86));
procedure {:inline 1} __VERIFIER_nondet_int()
  returns ($r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 94));
...
axiom (__SMACK_top_decl == $sub.ref(0, 102));
procedure {:inline 1} __SMACK_top_decl.ref($p0: ref);
const __SMACK_check_memory_safety: ref;
axiom (__SMACK_check_memory_safety == $sub.ref(0, 110));
...
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 118));
...
axiom (__VERIFIER_Assert == $sub.ref(0, 126));
procedure {:inline 1} __VERIFIER_Assert(cond: i32)
{
  var $i0: i1;
$bb0:
  call {:cexpr "cond"} boogie_si_record_i32(cond);
  assume {:sourceloc "standard_copy1_ground-1.c", 2, 39} true;
  $i0 := $ne.i32(cond, 0);
  assume {:sourceloc "standard_copy1_ground-1.c", 2, 39} true;
...
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "standard_copy1_ground-1.c", 2, 79} true;
  $exn := false;
  return;
$bb2:
  assume !(($i0 == 1));
  assume {:sourceloc "standard_copy1_ground-1.c", 2, 57} true;
  call __VERIFIER_error();
  assume {:sourceloc "standard_copy1_ground-1.c", 2, 57} true;
  assume false;
}
const main: ref;
axiom (main == $sub.ref(0, 134));
...
$bb0:
  call $initialize();
  call $p0 := $alloc($mul.ref(400, $zext.i32.i64(1)));
  call $p1 := $alloc($mul.ref(400, $zext.i32.i64(1)));
  // WARNING: ignoring llvm.debug call.
  assume true;
  // WARNING: ignoring llvm.debug call.
  assume true;
  call {:cexpr "a"} boogie_si_record_i32(0);
  assume {:sourceloc "standard_copy1_ground-1.c", 12, 9} true;
  $i2 := 0;
  goto $bb1;
$bb1:
  assume {:sourceloc "standard_copy1_ground-1.c", 12, 17} true;
  $i3 := $slt.i32($i2, 100);
  assume {:sourceloc "standard_copy1_ground-1.c", 12, 3} true;
  assume {:branchcond $i3} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i3 == 1);
  assume {:sourceloc "standard_copy1_ground-1.c", 13, 15} true;
  call $i4 := __VERIFIER_nondet_int();
  assume {:sourceloc "standard_copy1_ground-1.c", 13, 7} true;
  $i5 := $sext.i32.i64($i2);
  assume {:sourceloc "standard_copy1_ground-1.c", 13, 7} true;
  $p6 := $add.ref($p0, $mul.ref($i5, 4));
  assume {:sourceloc "standard_copy1_ground-1.c", 13, 7} true;
  $M.0 := $store.i32($M.0, $p6, $i4);
  assume {:sourceloc "standard_copy1_ground-1.c", 12, 25} true;
  $i7 := $add.i32($i2, 1);
...
$bb3:
  ...
  assume {:sourceloc "standard_copy1_ground-1.c", 17, 9} true;
  $i8 := 0;
  goto $bb4;
$bb4:
  assume {:sourceloc "standard_copy1_ground-1.c", 17, 17} true;
  $i9 := $slt.i32($i8, 100);
  assume {:sourceloc "standard_copy1_ground-1.c", 17, 3} true;
  assume {:branchcond $i9} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i9 == 1);
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 13} true;
  $i10 := $sext.i32.i64($i8);
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 13} true;
  $p11 := $add.ref($p0, $mul.ref($i10, 4));
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 13} true;
  $i12 := $load.i32($M.0, $p11);
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 5} true;
  $i13 := $sext.i32.i64($i8);
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 5} true;
  $p14 := $add.ref($p1, $mul.ref($i13, 4));
  assume {:sourceloc "standard_copy1_ground-1.c", 18, 5} true;
  $M.1 := $store.i32($M.1, $p14, $i12);
  assume {:sourceloc "standard_copy1_ground-1.c", 17, 25} true;
  $i15 := $add.i32($i8, 1);
...
$bb6:
  ...
  assume {:sourceloc "standard_copy1_ground-1.c", 22, 9} true;
  $i16 := 0;
  goto $bb7;
$bb7:
  assume {:sourceloc "standard_copy1_ground-1.c", 22, 17} true;
  $i17 := $slt.i32($i16, 100);
  assume {:sourceloc "standard_copy1_ground-1.c", 22, 3} true;
  assume {:branchcond $i17} true;
  goto $bb8, $bb9;
$bb8:
  assume ($i17 == 1);
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 25} true;
  $i18 := $sext.i32.i64($i16);
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 25} true;
  $p19 := $add.ref($p0, $mul.ref($i18, 4));
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 25} true;
  $i20 := $load.i32($M.0, $p19);
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 34} true;
  $i21 := $sext.i32.i64($i16);
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 34} true;
  $p22 := $add.ref($p1, $mul.ref($i21, 4));
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 34} true;
  ...
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 25} true;
  $i25 := $zext.i1.i32($i24);
  assume {:sourceloc "standard_copy1_ground-1.c", 23, 5} true;
  call __VERIFIER_Assert($i25);
  assume {:sourceloc "standard_copy1_ground-1.c", 22, 25} true;
  $i26 := $add.i32($i16, 1);
  call {:cexpr "x"} boogie_si_record_i32($i26);
  assume {:sourceloc "standard_copy1_ground-1.c", 22, 3} true;
  $i16 := $i26;
  goto $bb7;
$bb9:
  assume !(($i17 == 1));
  assume {:sourceloc "standard_copy1_ground-1.c", 25, 3} true;
  $r := 0;
  $exn := false;
  return;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 142));
procedure {:inline 1} llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 150));
